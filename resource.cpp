...
static void printVariableName(FILE* f, uint8_t id){
    switch(id){
        case VM_VARIABLE_RANDOM_SEED:           fprintf(f, "RANDOM_SEED"); break;
        case VM_VARIABLE_LAST_KEYCHAR:          fprintf(f, "LAST_KEYCHAR"); break;
        case VM_VARIABLE_HERO_POS_UP_DOWN:      fprintf(f, "HERO_POS_UP_DOWN"); break;
        case VM_VARIABLE_MUS_MARK:              fprintf(f, "MUS_MARK"); break;
        case VM_VARIABLE_SCROLL_Y:              fprintf(f, "SCROLL_Y"); break;
        case VM_VARIABLE_HERO_ACTION:           fprintf(f, "HERO_ACTION"); break;
        case VM_VARIABLE_HERO_POS_JUMP_DOWN:    fprintf(f, "HERO_POS_JUMP_DOWN"); break;
        case VM_VARIABLE_HERO_POS_LEFT_RIGHT:   fprintf(f, "HERO_POS_LEFT_RIGHT"); break;
        case VM_VARIABLE_HERO_POS_MASK:         fprintf(f, "HERO_POS_MASK"); break;
        case VM_VARIABLE_HERO_ACTION_POS_MASK:  fprintf(f, "HERO_ACTION_POS_MASK"); break;
        case VM_VARIABLE_PAUSE_SLICES:          fprintf(f, "PAUSE_SLICES"); break;
        default:
